      ...
      legend.onAdd = () => {
        ...
        div.innerHTML = `
          <div class="px-5 rounded-[1rem] py-4 bg-white flex flex-col gap-3">
            ...
            <div class="flex gap-2 items-center">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 20 20" fill="none" stroke="#138b27">
                <g id="SVGRepo_iconCarrier"> <path d="M2 9.75C2 9.33579 2.33579 9 2.75 9H17.25C17.6642 9 18 9.33579 18 9.75C18 10.1642 17.6642 10.5 17.25 10.5H2.75C2.33579 10.5 2 10.1642 2 9.75Z" fill="#138b27"/> </g>
                </svg>
              </div>
